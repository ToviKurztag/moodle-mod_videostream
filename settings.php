...
if ($ADMIN->fulltree) {
	...
	$settings->add(
        ...
        get_string('streaming_protocol', 'videostream'), '', '', 
                    array("php" => "php", "symlink" => "symlink", "dash" => "dash", "hls" => "hls", "vimeo" => "vimeo")));
	...
	// HLSingle base URL
    $settings->add(
        new admin_setting_configtext('videostream/hlsingle_base_url',
                                     get_string('hlsingle_base_url', 'videostream'),
                                     get_string('hlsingle_base_url_explain', 'videostream'),
                                     "",
                                     PARAM_RAW
                                     ));
